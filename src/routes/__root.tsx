...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Altairagency24 — Web Design & Development" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "Altairagency24" },
      { property: "og:title", content: "Altairagency24 — Web Design & Development" },
      {
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Archivo+Black&family=Instrument+Serif:ital@0;1&family=Inter:wght@400;500;600;700&display=swap",
      },
    ],
  }),
